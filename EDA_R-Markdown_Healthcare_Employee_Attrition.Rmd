...
```{r eval=FALSE}
model_nest <- tribble(
  ~model_type, ~Parameter_1,  ~Parameter_1_Value, ~Parameter_2, ~Parameter_2_Value
  ,"rf" ,"ntree"  ,100 ,"mtry" ,16
  ,"rf" ,"ntree"  ,200  ,"mtry" ,16
  ,"rf" ,"ntree"  ,400  ,"mtry" ,16
  ,"rf" ,"ntree"  ,800  ,"mtry" ,16
  ,"rf" ,"ntree"  ,1600  ,"mtry" ,16
)
